...
const VitalesGlicemia = db.vitales_glicemias;
...
module.exports = {
    create(req, res) {
        ...
        const datos = {         
            ...
            glucosa_sanguinea: form.glucosa_sanguinea,
            rbs: form.rbs,
            fbs: form.fbs,
            ppbs: form.ppbs,
            hba1c: form.hba1c,
            insulina_regular: form.insulina_regular,
            intermediario_insulina: form.intermediario_insulina,
            notas: form.notas,
            estado: 1,
    ...
    list(req, res) {
        ...
        VitalesGlicemia.findAndCountAll({ 
            include: [
                {
                    model: Usuario,
                    require: true,
