...
module.exports = {
    create(req, res) {
        ...
        const datos = {
            alergeno: form.alergeno.nombre,
            gravedad: form.gravedad.nombre,
            fecha_identificada: form.fecha_identificada,
            nota: form.nota,
            estado: 1,
            id_paciente: form.id_paciente,
            id_usuario: form.id_usuario,

            //Ingresar reacciones por aparte
            //reacciones: form.reacciones,
        };
        
        Alergia.create(datos)
        .then(diagnostico => {
