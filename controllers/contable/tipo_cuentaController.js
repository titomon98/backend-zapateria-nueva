...
module.exports = {
    ...
    list(req, res) {
        ...
        Tipo_Cuenta.findAndCountAll({ where: condition,order:[[`${criterio}`,`${order}`]],limit,offset})
        .then(data => {
    ...
    find (req, res) {
        ...
        return Tipo_Cuenta.findByPk(id)
    ...
    get (req, res) {
        Tipo_Cuenta.findAll({attributes: ['id', 'nombre']})
        .then(data => {
            res.send(data);
        })
        .catch(error => {
