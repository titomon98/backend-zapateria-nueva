...
module.exports = {
    ...
    list(req, res) {
        ...
        Clasificacion.findAndCountAll({ where: condition,order:[[`${criterio}`,`${order}`]],limit,offset})
        .then(data => {
    ...
    find (req, res) {
        ...
        return Clasificacion.findByPk(id)
    ...
    get (req, res) {
        Clasificacion.findAll({attributes: ['id', 'nombre']})
        .then(data => {
            res.send(data);
        })
        .catch(error => {
